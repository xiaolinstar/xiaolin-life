...
使用方式：基于`yaml`文件的声明式配置、丰富的流水线模板
...
使用方式：基于`yaml`文件的声明式配置、基于 Docker 生态
...
Jenkins 作为入门产品可以学习，但界面复杂，使用体验较差，即便提供了 Ocean Blue UI 和 Jenkins X 分支。除非考虑兼容性以及团队技术栈基础，否则不推荐使用。
...
总的来说，个人开发者关注 GitHub Actions，中小型企业选择阿里云效或GitLb，极客或中大型企业技术转型探索和尝试Tekton、Argo CD。
