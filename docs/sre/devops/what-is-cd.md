...
![Integration Delivery Deployment](../img-what-is-cd/continuous-integration-delivery-deployment.webp)

我在《从0到1实现微服务架构（第2版）》中，发现持续交付与持续部署的概念刚好相反😅。

**持续部署**

![Continuous Deployment](../img-what-is-cd/continuous-deployment.png)

**持续交付**

![Continuous Delivery](../img-what-is-cd/continuous-delivery.png)
...
![CI,CD,CD](../img-what-is-cd/ci-cd-cd.png)
