...
![bupt-auto-clock](../img-github-actions/bupt-auto-clock.png)

由我完成的浙江师范大学自动打卡：

![zjnu-auto-clock](../img-github-actions/zjnu-auto-clock-workflows.png)
...
![workflow-template](../img-github-actions/workflow-template.png)
