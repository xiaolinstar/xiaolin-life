...
推荐选择20.04，22.04，均为LTS版本，不推荐24.04是因为最新版本相关的配套软件没跟上，可能会存在莫名其妙的问题，还难以修复。

初始化服务器系统时，支持多种类型，包括使用应用模板、**基于操作系统镜像**、使用容器镜像、**使用自定义镜像**，可以根据实际情况酌情选择。
...
国内云服务厂商的都默认了依赖包安装源，无需修改。如果是在VMWare 上安装 Ubuntu 22.04 LTS，需要注意的是，默认的安装源是 Ubuntu 官方的源，而不是国内的源，需要手动修改为国内的源。
...
7. Ubuntu 命令行安装 zsh、oh-my-zsh、插件以及相关配置，https://convivae.top/posts/ubuntu-ming-ling-xing-an-zhuang-zsh-oh-my-zsh-cha-jian-yi-ji-xiang-guan-pei-zhi/
8. Ubuntu系统下Oh My Zsh安装与配置全流程指南，https://comate.baidu.com/zh/page/4r7iiun4tmz
