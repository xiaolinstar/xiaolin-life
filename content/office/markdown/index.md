...
featureimage: "https://media.xiaolin.fun/img-markdown/txt-markdown.png"
build:
...
![DeepSeek 回复格式为 Markdown](https://media.xiaolin.fun/img-markdown/txt-markdown.png)
...
![Markdown文本源代码](https://media.xiaolin.fun/img-markdown/txt-markdown.png)
...
![markmap](https://media.xiaolin.fun/img-markdown/markmap.png)

2. [aippt](https://www.aippt.cn) 基于 Markdown 文本大纲格式快速生成PPT。

![aippt](https://media.xiaolin.fun/img-markdown/aippt.png)
